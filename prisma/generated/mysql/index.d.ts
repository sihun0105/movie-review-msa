...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'comment' | 'movie' | 'user' | 'movieScore' | 'movieVod' | 'article' | 'articleComments' | 'articleLikes' | 'cGVTheater' | 'matchPost' | 'matchApplication' | 'chatRoom' | 'chatRoomMember' | 'chatMessage'
